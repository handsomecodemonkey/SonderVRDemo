	...
	public class FrameState {
		...
		public void MoveTo(PanelPosition dest) {
			...
			switch ( dest ) {
				...
				rightVal = 100.0f;
				rightUnits = PositionUnits.Percent;
				break;
				...
				leftVal = 0.0f;
				leftUnits = PositionUnits.Percent;
				break;
				...
				topVal = 100.0f;
				topUnits = PositionUnits.Percent;
				break;
				...
				bottomVal = 0.0f;
				bottomUnits = PositionUnits.Percent;
				break;
				...
				h = 0.0f;
				hUnits = PositionUnits.Percent;
				vPositionType = PositionType.Center;
				v = 0.0f;
				vUnits = PositionUnits.Percent;
				break;
		...
		public Rect GetRect(bool includeMargins) {
			...
			if ( PanoplyCore.panoplyRenderer != null ) {
				...
				//Debug.Log(pxTop+' '+pxRight+' '+pxBottom+' '+pxLeft+' '+pxWidth+' '+pxHeight);
